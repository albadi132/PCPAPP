...
<!-- Start Modal -->
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
          ...
          <a @click="addField(input, form.participant)" class="border-2 text-sm border-blue-500 rounded-full font-bold text-blue-500 px-2 py-2 transition duration-300 ease-in-out hover:bg-blue-500 hover:text-white mr-6">  
Add more 
</a>
      ...
      <!-- Form End -->
        ...
        >
          ...
          <button @click="participants" :disabled="form.busy" class="px-4 py-2 text-white font-semibold bg-blue-500 rounded">
            Save
          </button>
        </div>
