                            ...
                            <div class="flex flex-wrap w-full p-6 space-y-4 text-sm leading-normal text-gray-700 sm:text-base sm:space-y-6">
                                <div class="flash-message">
                                    @if(Session::has('alert-success'))
                                        <div class="flex items-center px-6 py-4 mx-2 my-4 text-lg bg-green-200 rounded-md w-fullxl:w-2/4">
                                            <svg viewBox="0 0 24 24" class="w-5 h-5 mr-3 text-green-600 sm:w-5 sm:h-5">
                                                <path fill="currentColor" d="M12,0A12,12,0,1,0,24,12,12.014,12.014,0,0,0,12,0Zm6.927,8.2-6.845,9.289a1.011,1.011,0,0,1-1.43.188L5.764,13.769a1,1,0,1,1,1.25-1.562l4.076,3.261,6.227-8.451A1,1,0,1,1,18.927,8.2Z"/>
                                            </svg>
                                            <span class="text-green-800">  {{ Session::get('alert-success') }} </span>
                                        </div>
                                    @endif
