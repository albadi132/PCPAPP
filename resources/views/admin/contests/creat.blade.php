...
@endif
  <h3 class="text-gray-700 text-3xl font-medium"><a href="{{ route('contests-view') }}">contests/</a>creat</h3>
  <section class="py-40 bg-opacity-50 h-screen">
    <form  method="POST" action="{{ route('contests-creat') }}" enctype="multipart/form-data">
      @csrf
